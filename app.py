...
if not st.session_state.setup_complete:
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Software Engineer", "Project Manager", "Quality Assurance Engineer", "Product Owner", "Product Manager"),
            index=("Software Engineer", "Project Manager", "Quality Assurance Engineer", "Product Owner", "Product Manager").index(st.session_state["position"])
        )

    st.session_state["company"] = st.selectbox(
        "Select a Company",
        ("Google", "Zoom", "Netflix", "Wells Fargo", "Goldman Sachs", "Delloite", "McKinsey & Company"),
        index=("Google", "Zoom", "Netflix", "Wells Fargo", "Goldman Sachs", "Delloite", "McKinsey & Company").index(st.session_state["company"])
    )
...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
    ...
    # Initializing the system prompt for the SmartHIRE
